        ...
        public function update()
	{
            ...
            $show['passport_series_number']       = array(
             ...
             $show['passport_date_issued']       = array(
               ...
               $show['birth_date']       = array(
                'name'  => 'birth_date',
                'id'    => 'birth_date',
                'type'  => 'text',
                'value' => $this->form_validation->set_value('birth_date', $userData['birth_date']),
            );
            ...
            'rows'  => '5',
            'value' => $this->form_validation->set_value('preference_district', $userData['preference_district']),
            );
             ...
             $show['city'] = array(
                ...
                'id'    => 'city',
                'type'  => 'text',
                'value' => $this->form_validation->set_value('city', $userData['city']),
            );
            ...
            $show['country'] = array(
                ...
                'id'    => 'country',
                'type'  => 'text',
                'value' => $this->form_validation->set_value('country', $userData['country']),
            );
            ...
            if ($this->form_validation->run() === TRUE)
                {
                    ...
                    if ($this->upload->do_upload('avatar'))
                    {
                       ...
                       redirect('cabinet/invoice', 'refresh');
                       return TRUE;
                } else {
