...
class Anons extends CI_Controller
{
    ...
    public function anonsUserOutput($output = null)
    {
        $this->load->view('anons.php', $output);
    }
...
//        $this->grocery_crud->columns('anons_date','name','email','phone');
        $this->grocery_crud 
            ...
            ->display_as('name', 'Имя')
            ->display_as('email', 'электронная почта')
    ...
    public
        function film_management_twitter_bootstrap()
    {
        try
        {
            $crud = new grocery_CRUD();
    ...
    public
        function employees_management2()
    {
        $crud = new grocery_CRUD();
    ...
    public
        function customers_management2()
    {
