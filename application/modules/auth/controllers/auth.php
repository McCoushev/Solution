...
class Auth extends CI_Controller
{
    ...
    function anons()
    {
        ...
        $username = $this->input->post('first_name');
            ...
            if ($this->ion_auth->anons_register($username, $email, $phone) == true)
            {
                $this->data['message'] = 'Вы успешно зарегистрировались.';
                $this->data['sucsess'] = TRUE; 
                
                $data['rname'] = $this->input->post('first_name');
                $data['remail'] = $this->input->post('email');
                $data['rphone'] = $this->input->post('phone');
                
                
                
                
                $this->anons_sucsess($username, $email, $phone);
                
               $this->data['modal'] = $this->load->view('auth/anons_sucsess', $data, true);
         ...
         $this->_render_page('auth/anons_register', $this->data);
    }

    function anons_register()
    {
        ...
        // validate new data
        $this->form_validation->set_rules('passport_series', $this->lang->line('create_user_validation_passport_data'), 'required|xss_clean');
        $this->form_validation->set_rules('passport_series_number', $this->lang->line('create_user_validation_passport_data'), 'required|xss_clean');
        $this->form_validation->set_rules('passport_issued', $this->lang->line('create_user_validation_passport_issued'), 'required|xss_clean');
        $this->form_validation->set_rules('passport_date_issued', $this->lang->line('create_user_validation_fname_label'), 'required|xss_clean');
        $this->form_validation->set_rules('address_registration', $this->lang->line('create_user_validation_faddress_registration'), 'required|xss_clean');
        $this->form_validation->set_rules('address_residence', $this->lang->line('create_user_validation_address_residence'), 'required|xss_clean');
        $this->form_validation->set_rules('birth_date', $this->lang->line('create_user_validation_birth_date'), 'required|xss_clean');
        $this->form_validation->set_rules('birth_place', $this->lang->line('create_user_validation_birth_place'), 'required|xss_clean');
        $this->form_validation->set_rules('iin', $this->lang->line('create_user_validation_iin'), 'required|xss_clean');
        $this->form_validation->set_rules('preference_region', $this->lang->line('create_user_validation_region_label'), 'required|xss_clean');
        $this->form_validation->set_rules('preference_district', $this->lang->line('create_user_validation_district_label'), 'required|xss_clean');
        $this->form_validation->set_rules('preference_square', $this->lang->line('create_user_validation_square_label'), 'required|xss_clean');
        ...
        else
        {
            ...
            $this->_render_page('auth/anons', $this->data);
        }
    }
