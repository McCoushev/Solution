		...
		<h1 class="head">Контакты</h1>
                ...
                <div class="row page-contact-head">
                    ...
                    <div class="span4 contact">
                       ...
                       <p>
                           Если Вы  проявили интерес к нашему предложению или у Вас возникли вопросы, то добро пожаловать к нам в офис. Мы находимся в центре Москвы, метро Белоруская (кольцевая) в бизнес Центре "Лесная Плаза", 4-ый Лесной переулок д.4, офис 524. 
Для вашего удобства, перед тем как посетить нас, позвоните нам по тел +7(495) 222 22 22 и мы выберем удобное для всех нас время. 
<br /><br />
Или напишите нам.
                       </p>
                    </div>
